...
export default function PioneerAuthGate() {
  ...
  useEffect(() => {
    ...
    script.onload = () => {
      try {
        // MESH-SYNC: Hardware lock engaged for Production E-Network
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-6 font-sans">
      <div className="mesh-container bg-black text-yellow-500 p-8 rounded-lg border border-gray-700 max-w-md w-full shadow-[0_0_20px_rgba(234,179,8,0.1)]">
        <h2 className="text-2xl font-bold mb-4 tracking-wide border-b border-gray-700 pb-2">Adjudicator Entry: Mainnet</h2>
        ...
        {pioneerData ? (
          <div className="mt-4 flex flex-col gap-4">
            ...
            <div className="border border-yellow-500 p-4 rounded bg-gray-900 mt-2">
              <p className="text-sm text-gray-400 mb-4">Execute a Mainnet transaction to verify Production completion.</p>
              <button 
